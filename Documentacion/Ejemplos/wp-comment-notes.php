...
class WP_Comment_Notes
{
   ...
   /**
    * Propiedad estática para contener nuestra instancia singleton
    *
    */
   ...
   /**
    * Si existe una instancia, la devuelve. Si no, crea uno y
    * lo devuelve.
    *
   ...
   /**
    * mostrar campos meta para notas meta
    *
    * @return void
    */
   ...
   public function wpcmn_notes_meta($post)
   {
      ...
      // obtener postmeta y nuestra configuración inicial
